odoo.define('snippet_boxed_73lines.s_media_block_editor', function (require) {
    'use strict';
    ...
    require("snippet_boxed_73lines.s_media_block_frontend");

    var QWeb = core.qweb;

    ajax.loadXML('/snippet_boxed_73lines/static/src/xml/s_media_block_modal.xml', core.qweb);
    ...
    s_options.registry.s_media_block = s_options.Class.extend({
        video_opt: function (type, value, $li) {
            ...
            self.$modal = $(QWeb.render("snippet_boxed_73lines.s_media_block_modal"));
